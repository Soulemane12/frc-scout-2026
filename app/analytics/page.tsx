...
import { loadEntries, loadPitEntries } from "../lib/storage";
  ...
  if (!entries.length) {
    return (
      <div className="rounded-xl border border-dashed border-slate-300 bg-white py-16 text-center">
        ...
        <p className="text-sm text-slate-400 mt-1">Scout some pits to see analytics</p>
      </div>
    );
  }
